...
const generateLinkBtn = document.getElementById('generate-link') as HTMLButtonElement;
const shareableLink = document.getElementById('shareable-link') as HTMLElement;
const downloadBtn = document.getElementById('download-resume') as HTMLButtonElement;
...
downloadBtn.addEventListener('click', () => {
  try {
    const resumeSection = document.getElementById('resume-output') as HTMLElement;
