...
class BookCollection:
    ...
    def read_from_file(self):
        ...
        try:
            with open(self.storage_file, "r", encoding="utf-8") as file:
                ...
                if not isinstance(self.book_list, list):  # Ensure it's a list
                    self.book_list = []
    ...
    def create_new_book(self):
        ...
        if not book_title or not book_author or not publication_year.isdigit():
            print("Invalid input! Book title, author, and publication year are required.\n")
            return
    ...
    def find_book(self):
        ...
        found_books = [
            ...
            if (search_text in book["title"].lower() and search_type == "1") or
               (search_text in book["author"].lower() and search_type == "2")
        ]
