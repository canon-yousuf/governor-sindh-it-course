...
const config: Config = {
  ...
  stylesheets: [
    {
      ...
      type: 'text/css',
      integrity:
        'sha384-odtC+0UGzzFL/6QkHlJFBMAX4ry5427lxRE2eHzWhEthZwIAVL0WnBcKlCtLyx5H',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI & Humanoid Robotics. build by Canon`,
    },
    prism: {
